...
DEFINES = ['NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_IF_TUN_H=1', 'HAVE_GSL=1']
...
EXAMPLE_DIRECTORIES = ['udp', 'stats', 'tcp', 'ipv6', 'naming', 'matrix-topology', 'socket', 'realtime', 'routing', 'udp-client-server', 'energy', 'wireless', 'error-model', 'tutorial']
...
NS3_EXECUTABLE_PATH = ['/home/chris/git/NS3-simulation/ns-3.18/build/src/emu', '/home/chris/git/NS3-simulation/ns-3.18/build/src/fd-net-device', '/home/chris/git/NS3-simulation/ns-3.18/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/i686-linux-gnu/4.6', '/home/chris/git/NS3-simulation/ns-3.18/build']
...
VALGRIND_FOUND = True
VERSION = '3.18'
WITH_PYBINDGEN = '/home/chris/git/NS3-simulation/pybindgen-0.16.0.831'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/chris/git/NS3-simulation/ns-3.18/build/ns3/config-store-config.h', '/home/chris/git/NS3-simulation/ns-3.18/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_PACKET_H', 'HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_GSL']
